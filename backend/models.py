...
class OpenAIProvider:
    """OpenAI API provider implementation (gpt-4o-mini etc.)."""
    ...
    def chat(
        ...
        **kwargs
        ...
        """Send a chat request to OpenAI, returning Ollama-like response format."""
        ...
        # Structured output: callers pass a JSON schema via format kwarg
